      ...
      <div class="main_container">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              ?>
                        <tr>
                          ...
                          <td><?php echo $row['code_generated']; ?></td>
                          <td><?php echo $row['result1']; ?></td>
                          <td><?php echo $row['result2']; ?></td>
                          <td><?php echo $row['result3']; ?></td>
                          <td><?php echo $row['w_reading']; ?></td>
                          <td><?php echo $row['h_reading']; ?></td>
                          <td><?php echo $row['shift']; ?></td>
                         <td>
                            <a href="<?php echo base_url(); ?>admin/qc_data/edit/<?php echo $row['qc_data_id'];  ?>" class="btn btn-success btn-xs btn-labeled fa fa-wrench" data-toggle="tooltip"   title="edit">
                              <?php echo 'edit';?></a>

                              <a class="btn btn-danger btn-xs fa fa-trash delete" title="delete" data-toggle="tooltip" onclick="del_view('<?php echo $row['qc_data_id']; ?>')"
                         data-original-title="Delete" data-container="body" id="<?php echo $row['qc_data_id']; ?>">
                         <?php echo 'delete';?></a>
        ...
        <div class="modal inmodal fade" id="del_modal" tabindex="-1" role="dialog"  aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <form method="post" action="<?php echo base_url();?>index.php/admin/qc_data/del_view" >
