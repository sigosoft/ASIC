        ...
        <div class="right_col" role="main" style="min-height: 3664px;">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content" id="section_bodyy">
                    ...
                    <!--  <div class="form-group" style="margin-left:500px">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" onclick="printDiv('section_bodyy')" class="btn btn-success">Convert to excel</button>
                        </div>
                      </div>-->
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>Raw Material 5</th>
                          <th>Raw Material 6</th>
