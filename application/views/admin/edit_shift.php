                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php foreach($result as $row){
                      ?>
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>admin/shift/update_shift/<?php echo $row['shift_id']; ?>">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Date
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="shift_date" name="shift_date"  class="form-control col-md-7 col-xs-12" value="<?php echo $row['date']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select id="team" name="team" required="required" class="form-control col-md-7 col-xs-12" >
                            ...
                            ?>
                            <option value="<?=$team['team_id']?>" <?php if($row['production_team'] ==  $team['team_id']){echo "selected";} ?>><?=$team['team_name']?></option>
                          <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="mould" name="mould" required="required" class="form-control col-md-7 col-xs-12" >
                            ...
                            ?>
                            <option value="<?=$moulds['mould_id']?>" <?php if($row['mould'] ==  $moulds['mould_id']){echo "selected";} ?>><?=$moulds['mould_name']?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="color" name="color" required="required" class="form-control col-md-7 col-xs-12" >
                            ...
                            ?>
                            <option value="<?=$colors['color_id']?>" <?php if($row['color'] ==  $colors['color_id']){echo "selected";} ?>><?=$colors['color_name']?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="mix" name="mix" required="required" class="form-control col-md-7 col-xs-12" >
                            <option value="">SELECT</option>
                            <?php $mix =  $this->db->get('mix_design_code')->result_array();
                                  foreach($mix as $mixs){
                            ?>
                            <option value="<?=$mixs['code_id']?>" <?php if($row['color'] ==  $mixs['code_id']){echo "selected";} ?>><?=$mixs['code_name']?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="qty" name="qty" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $row['quantity']; ?>">
